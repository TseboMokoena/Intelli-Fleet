<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Reports.aspx.vb" Inherits="Intelli_Fleet_Web.Reports" %>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Total Income(Rands) on a monthly basis</h4>
                            ...
                            <div class="panel panel-default recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title"> Amount of money(Rands) saved on a monthly basis
                                    </h4>
                                    <div class="panel-actions">
                            ...
                            <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title"> Previous vs Current year profits(Rands) </h4>
                                    <div class="panel-actions">

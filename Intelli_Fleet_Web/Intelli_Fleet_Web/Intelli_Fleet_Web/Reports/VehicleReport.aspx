<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="VehicleReport.aspx.vb" Inherits="Intelli_Fleet_Web.VehicleReport1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="panel panel-default">
                         <div class="panel-heading">
                                    <h4 class="panel-title"> Actual Performance vs Desired Performance </h4>
                            ...
                            <div class="panel panel-default ">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Vehicles making most money</h4>
                                    <div class="panel-actions">
                           ...
                           <div class="panel panel-default ">
                            <div class="panel-heading">
                                    <h4 class="panel-title"> Mileage Covered</h4>
                                    <div class="panel-actions">
                               ...
                               <div class="panel panel-default">
                         <div class="panel-heading">
                                    <h4 class="panel-title"> Money made based on the number of vehicles</h4>
                                    <div class="panel-actions">
                                    </div>
                             </div>
                              <div>
     ...
     <asp:HiddenField ID="day7" runat="server" />
      ...
      <script type="text/javascript">
          $(function () {
              ...
              var object = (document.getElementById('MainContent_txtBranch').innerHTML);
              var object1 = (document.getElementById('MainContent_txtBranch').innerHTML);
              var object2 = (document.getElementById('MainContent_txtBranch').innerHTML);
              var object3 = (document.getElementById('MainContent_txtBranch').innerHTML);

              object = JSON.parse(object);
              object1 = JSON.parse(object1);
              object2 = JSON.parse(object2);
              object3 = JSON.parse(object3);
    ...
    <script>
           $(function () {
               ...
               var lineData = {
                   labels: ["10% More", "Current", "10% Less"],
                   datasets: [
                       {
                           label: "Example dataset",
                           fillColor: "rgba(220,220,220,0.5)",

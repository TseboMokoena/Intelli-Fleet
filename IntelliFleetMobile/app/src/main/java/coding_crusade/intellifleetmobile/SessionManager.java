...
/**
 * Created by ObesT on 2016-08-08.
 */
public class SessionManager {
     ...
     * */
    public void createLoginSession(String name, String UserType){
    ...
    public void SetVehicle(String VehicleReg)
    {
        editor.putString(KEY_VEHICLE, VehicleReg);
        // commit changes
        editor.commit();
    }
    ...
    {
        editor.putString(KEY_WORKING, work);
        // commit changes
        editor.commit();
    }
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        user.put(KEY_WORKING, pref.getString(KEY_WORKING,null));

        user.put(KEY_DELIVERIES, pref.getString(KEY_DELIVERIES,null));
        // return user
        return user;
    }
